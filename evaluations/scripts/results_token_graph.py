...
plt.xlabel('Number of Training Tokens ($T$)', fontsize=14, fontweight='bold', labelpad=15)
plt.ylabel('Expected Reward $\mathbb{E}[R(S_{T})] \pm \sigma$', fontsize=14, fontweight='bold', labelpad=15)
plt.title('Training Efficiency Analysis\nReward Performance vs. Token Consumption', 
...
plt.savefig('ra_tokens_reward.png', 
            dpi=300, 
            bbox_inches='tight',
            facecolor='white',
            edgecolor='none')
