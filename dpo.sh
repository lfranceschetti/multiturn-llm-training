...
#SBATCH --output=dpo_multi_game.out    # Output log file
#SBATCH --error=dpo_multi_game.err    # Error log file
...
python multiturn_llm_training/DPO/create_dataset.py --model "$MODEL_NAME" --num-samples 8000 --game-type multi-game --hf-repo LuckyLukke/negotio_DPO